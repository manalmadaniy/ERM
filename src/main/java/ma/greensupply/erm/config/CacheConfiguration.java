package ma.greensupply.erm.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("komplians");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("komplians");
        ...
        config.getMapConfigs().put("ma.greensupply.erm.domain.*", initializeDomainMapConfig(jHipsterProperties));
