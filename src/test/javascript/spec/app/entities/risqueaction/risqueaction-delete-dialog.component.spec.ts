...
describe('Component Tests', () => {
  describe('Risqueaction Management Delete Component', () => {
    let comp: RisqueactionDeleteDialogComponent;
    let fixture: ComponentFixture<RisqueactionDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [RisqueactionDeleteDialogComponent],
      })
        .overrideTemplate(RisqueactionDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(RisqueactionDeleteDialogComponent);
